...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleDataIntegrityViolation(DataIntegrityViolationException ex,
		...
		if (ex.getCause() instanceof ConstraintViolationException) {
			return buildResponseEntity(new ApiError(BAD_REQUEST, "Database error", ex.getCause()));
		}
	...
	public ResponseEntity<Object> handleDataException(DataException ex) {
		ApiError apiError = new ApiError(HttpStatus.CONFLICT);
		if(ex.getUserMessage() == null || ex.getUserMessage().isEmpty()) {
			apiError.setMessage("Error en la entrada de Datos");	
		}else {
			apiError.setMessage(ex.getUserMessage());
		}
	...
	public ResponseEntity<Object> handleNotFoundException(NotFoundException ex) {
		...
		if (ex.getUserMessage() == null || ex.getUserMessage().isEmpty()) {
			apiError.setMessage("Error http");
		} else {
			apiError.setMessage(ex.getUserMessage());
		}
		if (ex.getDebugMessage() == null || ex.getDebugMessage().isEmpty()) {
			apiError.setDebugMessage(ex.getMessage());
		} else {
	...
	public ResponseEntity<Object> handleUniqueDataException(UniqueDataException ex) {
