...
values 
(1,'1967-10-09', 'test@gmail.com' , 'Peréz' ,'José', '1746039118' , 'c'),
(2,'1987-09-09', 'test1@gmail.com' , 'Calle' ,'Maria', '1750030060' , 's'),
(3, '1977-08-09', 'test1@gmail.com' , 'Almeida' ,'Juan', '1711889461' , 'd');
...
values 
(1, 'DEPOSITO', 30.00, 'DEPOSITO POR VENTANILLA','2021-06-09', 1 ),
(2, 'RETIRO', 80.00, 'RETIRO POR VENTANILLA','2021-05-09',   1 ),
(3, 'DEPOSITO', 200.00, 'DEPOSITO POR VENTANILLA','2021-04-09', 1 ),
(4, 'DEPOSITO', 99.00, 'DEPOSITO POR VENTANILLA','2021-06-09', 2 ),
(5, 'RETIRO', 500.00, 'RETIRO POR VENTANILLA','2021-05-09',   2),
(6, 'DEPOSITO', 1000.00, 'DEPOSITO POR VENTANILLA','2021-04-09', 2),
(7, 'DEPOSITO', 800.00, 'DEPOSITO POR VENTANILLA','2021-05-09', 3),
(8, 'RETIRO', 20.00, 'RETIRO POR VENTANILLA','2021-04-09',   4 ),
(9, 'DEPOSITO', 900.00, 'DEPOSITO POR VENTANILLA','2021-01-09', 5);
